        ...
        <div className="mt-28 flex w-full flex-col gap-16">
            <div className="mx-auto w-full max-w-[1560px] px-10 max-[1367px]:px-10">
                <div className="flex w-full items-center justify-between max-[601px]:flex-col">
                    <p className="font-sora text-5xl font-medium tracking-tight text-secondary">
                        Cases
                    </p>
                    <a
                        href="/"
            ...
            <Carousel className="ml-auto w-full max-w-[1740px] pl-10">
                <CarouselContent className="-ml-5">
                    {cases.map((item, idx) => (
                        <CarouselItem
                            key={idx}
                            className="h-[526px] pl-5 basis-[calc(100%/3.6)] max-[1281px]:basis-[calc(100%/2.5)] max-[769px]:basis-[calc(100%/1.2)] max-[601px]:basis-[calc(100%/1.1)] select-none"
                        >
