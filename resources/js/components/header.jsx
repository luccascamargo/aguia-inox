...
export function Header() {
    ...
    return (
        <header className="border-b-4 border-primary">
            <div className="mx-auto flex h-[130px] w-full max-w-[1658px] items-center justify-between px-10 max-[601px]:h-[80px] max-[601px]:px-4">
                <a href="/">
                    <img
                        src="/logo.svg"
                ...
                <div className="hidden items-center min-[1280px]:flex">
                    <nav>
                        <ul className="flex items-center space-x-12">
                            <li>
                                <a
                                    href="/empresa"
                                    className="font-sora font-normal text-secondary capitalize transition-all duration-500 hover:font-bold"
                                >
                                    Empresa
                                </a>
                            </li>
                            <li ref={productsMenuRef}>
                                <button
                                    ...
                                    className="flex cursor-pointer items-center gap-2 font-sora text-secondary capitalize transition-all duration-500 hover:font-bold"
                                >
                                    Produtos
                                    <ChevronDown
                                        size={20}
                            ...
                            <li>
                                <a
                                    href="/news"
                                    className="font-sora text-secondary transition-all duration-500 hover:font-bold"
                                >
                                    News
                                </a>
                            </li>
                    ...
                    <div className="ml-8 flex items-center gap-6">
                        ...
                        <a
                            ...
                            target="_blank"
                            className="group flex h-[54px] w-[54px] items-center justify-center rounded-[10px] border-2 border-primary transition-all duration-500 hover:border-secondary hover:bg-secondary"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 448 512"
                                className="h-8 w-8 fill-primary transition-all duration-500 group-hover:fill-white"
                            >
                ...
                <div className="border-t border-gray-200 bg-white shadow-lg min-[1235px]:hidden">
                    <div className="px-10 py-4">
                        ...
                        <div className="flex items-center gap-4">
                            <Button className="h-[43px] w-full">
                                Solicite um orçamento
                            </Button>
